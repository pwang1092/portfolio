...
const Works = () => {
    return (
        <section id='works'>
            ...
            <span className="worksDesc">I've been exploring different areas of computer science recently, including web design, computer vision, and data science and visualization. Visit my project code by clicking the images below! (website built with React, OpenCV project, and data science project on COVID vaccination efficacy) </span>
