...
const Works = () => {
    return (
        <section id='works'>
            ...
            <span className="worksDesc">I've been exploring different areas of computer science recently, including web design, computer vision, and data science and visualization. </span>
